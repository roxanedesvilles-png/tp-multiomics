...
```{r}
data_t2d <- readRDS("/home/amory/Bureau/Études/2025 - 2026/M2 Biologie Informatique/Bioinformatique des omiques et de la métagénomique/multi-omique/data_t2d.Rds")
...
```{r}
plotDiablo(final.diablo.model, ncomp = 3)
...
network(final.diablo.model, blocks = c(1,2,3),
        color.node = c('darkorchid', 'brown1', 'lightgreen'), cutoff = 0.8)
```
